...
// Stack represents a stack in AuruOS, a set of instructions to build a container.
type Stack struct {
	Name       string
	Base       string
	Packages   []string
...
// this func does not return an error, since AuruOS is meant to be portable and
